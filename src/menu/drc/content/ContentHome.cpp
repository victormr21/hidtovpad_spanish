...
ContentHome::ContentHome():ContentTemplate()
    ...
    , welcomeHeadLineLabel("Bienvenido a HID to VPAD!")
    , welcomeTextLabel("HID to VPAD te permite usar tu dispositivo USB en tu WiiU. Actualmente puedes emular el GamePad o los Pro Controller.")
    , welcomeTextLabel2("Antes de usar tu dispositivo, puede que necesites proporcionar un archivo de configuración válido. Más información y archivos de configuración se puede encontrar en la sección ayuda o en gbatemp.net (gbatemp.net/threads/424127/).")
    , welcomeTextLabel3("Para emular un dispositivo, selecciona un mando de la lista de la izquierda.")
