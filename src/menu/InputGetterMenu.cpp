...
InputGetterMenu::InputGetterMenu(UController_Type controller_type)
    ...
    , infoText("Pulsa cualquier botón en el mando USB que quieres usar.", 35, glm::vec4(0.3f, 0.3f, 0.3f, 1.0f))
    , infoTextreturn("Pulsa B para cancelar la emulación", 55, glm::vec4(0.3f, 0.3f, 0.3f, 1.0f))
